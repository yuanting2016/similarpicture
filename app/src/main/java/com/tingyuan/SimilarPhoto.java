package com.tingyuan.kotlindemo.util;
...
public class SimilarPhoto {
    ...
    public static long calculateFingerPrint(Bitmap bitmap) {
        float scale_width, scale_height;
        scale_width = 8f / bitmap.getWidth();
        scale_height = 8f / bitmap.getHeight();
